...
public final class TitleAndDescriptionInfoView: UIView {
    ...
    // titleLabel: MLUILabel
    private let titleLabel: MLUILabel = {
        let titleLabel = MLUILabel(text: "")
        titleLabel.textColor = ColorPallet.green.color

        return titleLabel
    }()
    
    // descriptionLabel: MLUILabel
    private let descriptionLabel = MLUILabel(text: "")
